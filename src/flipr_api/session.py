# -*- coding: utf-8 -*-
"""Session manager for the Flipr REST API in order to maintain authentication Bearer token between calls."""
...
class FliprClientSession(Session):
    ...
    def __init__(self, username:str, password:str) -> None:
        ...
        payload_token = "grant_type=password&username=" + username + "&password=" + password
        headers_token = {
