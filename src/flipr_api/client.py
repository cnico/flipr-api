...
class FliprAPIRestClient:
    ...
    #
    # search for flipr ids. Generally not useful since flipr ID is to be known by the user.
    #
    ...
    def get_pool_measure_latest(self, flipr_id: str) -> PoolMeasure:
        """Retrieves most recents measure for the given flipr ID.
        ...
        resp= self.session.rest_request("GET", "modules/" + flipr_id + "/survey/last")
